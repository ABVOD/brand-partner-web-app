...
export default function LocationBasedCampaigns() {
  ...
  const getStatusConfig = (status: string) => {
    switch (status) {
      case 'scheduled':
        return { color: 'bg-amber-100 text-amber-800 border-amber-200', icon: ClockIcon };
      case 'active':
        return { color: 'bg-emerald-100 text-emerald-800 border-emerald-200', icon: SparklesIcon };
      case 'completed':
        return { color: 'bg-gray-100 text-gray-800 border-gray-200', icon: CheckCircleIcon };
      case 'paused':
        return { color: 'bg-red-100 text-red-800 border-red-200', icon: ClockIcon };
      default:
    ...
    <DashboardLayout>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="space-y-8">
          {/* Hero Header */}
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 px-8 py-12 shadow-2xl">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="hidden lg:block">
                  <button
                    ...
                    className="group relative overflow-hidden rounded-xl bg-white px-8 py-4 text-lg font-semibold text-indigo-600 shadow-lg transition-all duration-300 hover:bg-indigo-50 hover:shadow-xl hover:scale-105"
                  >
                    <div className="flex items-center space-x-3">
          ...
          <div className="lg:hidden">
            <button
              onClick={() => setIsCreating(true)}
              className="w-full rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 px-6 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:shadow-xl"
            >
                ...
                <div className="relative w-full max-w-6xl mx-auto">
                  <div className="relative rounded-2xl bg-white shadow-2xl">
                    ...
                    <div className="border-b border-gray-200 px-8 py-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <h2 className="text-2xl font-bold text-gray-900">Create Location Campaign</h2>
                          <p className="text-gray-600 mt-1">Launch a promotional campaign with location targeting and track redemptions</p>
                        </div>
                        <button
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 p-6 border border-blue-100">
                          <h3 className="text-lg font-semibold text-gray-900 mb-6 flex items-center">
                            <div className="rounded-lg bg-blue-500 p-2 mr-3">
                          ...
                          <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            <div className="lg:col-span-2">
                              ...
                              <input
                                ...
                                className="w-full rounded-lg border-0 bg-white px-4 py-3 text-gray-900 shadow-sm ring-1 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500 transition-all duration-200"
                              />
                            </div>
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className="w-full rounded-lg border-0 bg-white px-4 py-3 text-gray-900 shadow-sm ring-1 ring-gray-300 focus:ring-2 focus:ring-indigo-500 transition-all duration-200"
                              />
                            </div>
                                  ...
                                  <div className="absolute top-2 right-2">
                                    <button
                                      onClick={() => {
                                        setBannerPreview('');
                                        setSelectedBanner(null);
                                        setNewCampaign(prev => ({ ...prev, bannerImage: '' }));
                                      }}
                        ...
                        {/* Location Selection */}
                        <div className="rounded-xl bg-gradient-to-r from-emerald-50 to-green-50 p-6 border border-emerald-100">
                          <h3 className="text-lg font-semibold text-gray-900 mb-6 flex items-center">
                            <div className="rounded-lg bg-emerald-500 p-2 mr-3">
                          ...
                          />
                          {newCampaign.location?.address && (
                            <div className="mt-4 p-3 bg-white rounded-lg border border-emerald-200">
                              <div className="flex items-start space-x-2">
                                <MapPinIcon className="h-4 w-4 mt-0.5 flex-shrink-0 text-emerald-600" />
                                <div>
                                  <p className="font-medium text-gray-900">{newCampaign.location.address}</p>
                                  <p className="text-sm text-gray-600">Coordinates: {newCampaign.location.lat.toFixed(6)}, {newCampaign.location.lng.toFixed(6)}</p>
                                  <p className="text-sm text-emerald-600 mt-1">Radius: {formatRadius(newCampaign.location.radius)}</p>
                                </div>
                              </div>
                            </div>
                          )}
                        ...
                        {newCampaign.campaignFee && newCampaign.campaignFee > 0 && (
                          <div className="rounded-xl bg-gradient-to-r from-yellow-50 to-orange-50 p-6 border border-yellow-200">
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600">Radius ({formatRadius(newCampaign.location?.radius || 0)}):</span>
                                <span className="font-medium">${((newCampaign.location?.radius || 0) / 1000 * 25).toFixed(2)}</span>
                              </div>
                              <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600">Duration ({Math.ceil((newCampaign.endDate!.getTime() - newCampaign.startDate!.getTime()) / (1000 * 60 * 60 * 24))} days):</span>
                                <span className="font-medium">${(Math.ceil((newCampaign.endDate!.getTime() - newCampaign.startDate!.getTime()) / (1000 * 60 * 60 * 24)) * 15).toFixed(2)}</span>
                              </div>
                              <div className="border-t border-yellow-300 pt-3">
                                <div className="flex justify-between items-center">
                                  <span className="text-lg font-semibold text-gray-900">Total Campaign Fee:</span>
                                  <span className="text-2xl font-bold text-yellow-600">${newCampaign.campaignFee.toFixed(2)}</span>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        {qrCodePreview && (
                          <div className="lg:col-span-2">
                            ...
                            <div className="relative rounded-lg overflow-hidden border border-gray-200 bg-white p-6">
                              <div className="flex items-center justify-center">
                                <div className="text-center">
                                  ...
                                  <p className="text-sm text-gray-600 mt-2">
                                    Customers can scan this QR code to redeem: <span className="font-medium">{newCampaign.couponCode}</span>
                                  </p>
                                </div>
                              </div>
                              <div className="absolute top-2 right-2">
                                <button
                                  onClick={() => {
                                    setQrCodePreview('');
                                    setNewCampaign(prev => ({ ...prev, qrCodeData: '', couponCode: '' }));
                                  }}
                                  className="bg-red-500 text-white rounded-full p-1 hover:bg-red-600 transition-colors"
                                >
                                  <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="border-t border-gray-200 px-8 py-6">
                      <div className="flex items-center justify-end space-x-4">
                        <button
                          onClick={() => setIsCreating(false)}
                          className="rounded-lg px-6 py-3 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors duration-200"
                        >
                          Cancel
                        </button>
                        <button
                          onClick={handleCreateCampaign}
                          className="rounded-lg bg-gradient-to-r from-indigo-600 to-blue-600 px-8 py-3 text-sm font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105"
                        >
                          Create Campaign
                        </button>
                      </div>
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Manage your location-based advertising campaigns</p>
                </div>
                {campaigns.length > 0 && (
              ...
              <div className="space-y-6">
                {campaigns.map((campaign) => {
                  ...
                  return (
                    <div
                      key={campaign.id}
                      className="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-lg hover:border-indigo-200"
                    >
                      {/* Campaign Header */}
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-start space-x-4">
                          <div className="rounded-xl bg-blue-50 border-blue-200 border p-3">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-2 text-sm text-gray-500">
                              <div className="flex items-start space-x-2">
                                ...
                                <div>
                                  <p className="font-medium text-gray-700">{campaign.location.address || 'Selected Location'}</p>
                            ...
                            <div className="mt-3 p-3 bg-green-50 rounded-lg border border-green-200">
                              <p className="text-sm text-green-800 font-medium">Offer:</p>
                              <p className="text-sm text-green-700">{campaign.offerDetails}</p>
                            </div>
                            ...
                            {campaign.qrCodeData && (
                              <div className="mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                <div className="flex items-center justify-between mb-2">
                                  <p className="text-sm text-blue-800 font-medium">QR Coupon Code:</p>
                                ...
                                <div className="flex items-center space-x-3">
                                  <img 
                                    ...
                                    className="w-16 h-16 rounded border border-blue-300"
                                  />
                                  <div>
                                    <p className="text-sm text-blue-700 font-medium">{campaign.couponCode}</p>
                                    <p className="text-xs text-blue-600">Scan to redeem offer</p>
                                  </div>
                                </div>
                              </div>
                            )}
                        ...
                        <div className="flex items-center space-x-2">
                          <button className="rounded-lg bg-gray-50 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors duration-200">
                            Analytics
                          </button>
                          <button className="rounded-lg bg-indigo-50 px-4 py-2 text-sm font-medium text-indigo-700 hover:bg-indigo-100 transition-colors duration-200">
                            Edit
                          </button>
                          <button className="rounded-lg bg-red-50 px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-100 transition-colors duration-200">
                            Deactivate
                          </button>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-100">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-sm text-gray-500 mt-1">Redemptions</div>
                        </div>
                      </div>
                      ...
                      {campaign.bannerImage && (
                        <div className="mt-6 pt-6 border-t border-gray-100">
                          <p className="text-sm font-medium text-gray-700 mb-2">Campaign Banner</p>
                          <img 
                ...
                {campaigns.length === 0 && (
                  <div className="text-center py-16">
                    <div className="rounded-full bg-gradient-to-r from-indigo-100 to-purple-100 w-20 h-20 flex items-center justify-center mx-auto mb-6">
                      <MapPinIcon className="h-10 w-10 text-indigo-600" />
                    </div>
                    ...
                    <button
                      onClick={() => setIsCreating(true)}
                      className="inline-flex items-center space-x-3 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 px-8 py-4 text-lg font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                    >
                      <PlusIcon className="h-6 w-6" />
